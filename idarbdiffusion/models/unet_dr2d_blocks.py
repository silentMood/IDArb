...
class UNetMidBlockDR2DCrossAttn(nn.Module):
    def __init__(
        self,
        in_channels: int,
        temb_channels: int,
...
class CrossAttnUpBlockDR2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class CrossAttnDownBlockDR2D(nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
